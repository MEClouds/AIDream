  ...
  return (
    <div>
      <Heading
        ...
        description="Generate Video form prompt"
        icon={VideoIcon}
      ...
      <div className="px-4 lg:px-8">
                  ...
                  <FormItem className=" col-span-12 lg:col-span-10 ">
                    <FormControl className="m-0 p-0 ">
                      <Input
                        ...
                        disabled={isLoading}
                        placeholder="camel moving in arab desert "
                        {...field}
                      />
                    </FormControl>
                  </FormItem>
        ...
        <div className="space-y-4 mt-4">
          ...
          {!video && !isLoading && (
            <Empty label="There is no video generated here" />
          )}

          {video && (
            <video
              controls
              className=" w-full aspect-video my-3 rounded-lg border bg-black "
            >
              <source src={video} />
            </video>
          )}
